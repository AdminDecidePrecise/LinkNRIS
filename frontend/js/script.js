...
//        "right": gap
 ...
 //  ============= send gifts EDIT FUNCTION =========

    $(".send-gifts").on("click", function () {
        $("#send-gifts").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".close-box").on("click", function () {
        $("#send-gifts").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    });
    ...
    $(".edit-profile-btn > a").on("click", function () {
        $("#edit-profile-box").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });

    $(".close-box").on("click", function () {
        $("#edit-profile-box").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    });
